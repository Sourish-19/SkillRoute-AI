...
const RevealLoader = ({
    ...
    useGSAP(
        () => {
            ...
            // Animate bars (starts center-out)
            tl.to(".preloader-item", {
                delay: 1, // Wait for initial text reveal to settle
                duration: 0.8,
            ...
            // Fade out text exactly when bars start moving
            tl.to(".name-text span", {
                autoAlpha: 0,
                duration: 0.4,
            }, "<");

            tl.to(preloaderRef.current, { autoAlpha: 0, duration: 0.1 });
        },
